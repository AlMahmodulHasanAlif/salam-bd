// src/codingLanding/CodingOrderSuccess.jsx
...
const CodingOrderSuccess = () => {
  ...
  useEffect(() => {
    if (!order) {
      const timer = setTimeout(() => navigate("/codingLanding"), 3000);
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      ...
      <div className="max-w-7xl mx-auto mb-6 flex justify-center bg-green-700 py-4">
        <img
          ...
          onClick={() => navigate("/codingLanding")}
        />
      </div>
          ...
          <div className="border-t border-gray-100 pt-4 space-y-3">
            ...
            <div className="flex flex-col items-center gap-3 text-gray-700 border border-green-200 rounded-xl p-4 bg-green-50/40">
              <div className="flex items-start justify-center gap-2">
                ...
                <span>
                  আপনার সন্তানের শেখার যাত্রা আরও এগিয়ে নিতে শিশুদের শিক্ষামূলক
                  পণ্যগুলো দেখে নিতে পারেন।
                </span>
              </div>
              <Link
                to="/kids"
            ...
            <div className="flex flex-col items-center gap-3 text-gray-700 border border-green-200 rounded-xl p-4 bg-green-50/40">
              <div className="flex items-start justify-center gap-2">
                <Trophy size={18} className="mt-0.5 shrink-0 text-green-600" />
                <span>
                  আপনার সন্তানের মেধার যাচাই করতে আমাদের মেধা যাচাই প্রতিযোগিতায়
                  অংশ নিতে পারেন।
                </span>
              </div>
              <Link
...
export default CodingOrderSuccess;
